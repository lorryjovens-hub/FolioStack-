...
import { initDB, run, get, closeDB, getType } from './db.js';
...
[uploadsDir, worksDir, dataDir].forEach(dir => {
...
app.get('/api/health', (req, res) => {
  ...
  console.log('Health check - Database type:', dbType);
  res.json({
    status: 'ok',
